...
export const Example = createReactBlockSpec(
  {
    type: "example",
    propSchema: {
      type: {
  ...
  {
    render: (props) => {
      return <ExampleBlockComponent {...props} />;
    },
  }
);

const ExampleBlockComponent = (props: any) => {
  ...
  return (
    <div role="alert" className="mt-3 flex items-center w-full p-3 text-sm text-slate-600 rounded-md bg-[#2A2D3E]">
      ...
      <h3 className="font-bold text-[#FF7AC6]">Example</h3>
      <input
        type="text"
        value={exampleName}
